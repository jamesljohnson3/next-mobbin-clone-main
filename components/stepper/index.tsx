...
const Stepper = React.forwardRef<HTMLDivElement, StepperProps>(
    (props, ref: React.Ref<HTMLDivElement>) => {
        ...
        const items = [] as React.ReactElement<StepProps>[];
        ...
        childArr.forEach((child, _index) => {
            ...
            if (child.type === Step) {
                const stepElement = child as React.ReactElement<StepProps>;
                const stepProps = {
                    ...stepElement.props,
                    component: stepElement.props.component,
                };
                items.push(React.cloneElement(stepElement, stepProps));
            } else {
                footer.push(child);
            }
        });
        ...
        const handleStepClick = (index: number) => {
            if (onClickStep) {
                onClickStep(index); // Call the onClickStep function if provided
            }
        };
        ...
        return (
            <StepperProvider
                value={{
                    ...
                    checkIcon,
                    errorIcon,
                    onClickStep: handleStepClick, // Pass the handleStepClick function to context
                    clickable,
                    stepCount,
                    isVertical,

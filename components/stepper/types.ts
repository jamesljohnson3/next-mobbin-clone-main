...
type StepItem = {
	...
	label?: string;
	description?: string;
    icon?: IconType | React.ReactNode; // Update the icon property to accept ReactNode
	optional?: boolean;
	component?: ReactNode; // Adding the component property
    containerRef?: React.RefObject<HTMLDivElement>; // Adding the containerRef property
...
interface StepperProps extends StepOptions {
	...
	initialStep: number;
	steps: StepItem[];
	containerRef: React.RefObject<HTMLDivElement>; // Add containerRef here
